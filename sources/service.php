<?php  if(!defined('_source')) die("Error");
		...
		if($id!=''){
			...
			#các tin cu hon
			$sql_khac = "select ten_$lang,ngaytao,id,tenkhongdau,thumb,mota_$lang from #_baiviet where hienthi=1 and id !='".$row_detail['id']."' and type='".$type_bar."' order by stt,ngaytao desc limit 0,10";
			$d->query($sql_khac);
