...
if($id!=''){
			...
			$pageURL=getCurrentPageURL_index();
			if ($row_detail=='') {
			...
			$d->reset();
			$sql_detail = "select * from #_product_list where hienthi=1 and type='".$type_bar."' and id='".$row_detail['id_list']."'";
			$d->query($sql_detail);
			...
			$d->reset();
			$sql = "select id,photo,ten_$lang,giaban,tenkhongdau,giacu from #_product where hienthi=1 and type='".$type_bar."' and banchay=1 order by stt,ngaytao desc";
			$d->query($sql);
			...
			$where = " #_product where hienthi=1 and type='".$type_bar."' and type='".$type_bar."' and id_list='".$row_detail['id_list']."' and id!='".$row_detail['id']."' order by stt,ngaytao desc";


			$sql = "select id,photo,ten_$lang,giaban,tenkhongdau,giacu,rate,mota_$lang,masp from $where $limit";
			$d->query($sql);
			...
			$d->reset();
			$sql = "select id,ten_$lang,tenkhongdau, mota_$lang,title,keywords,description from #_product_list where hienthi=1 and type='".$type_bar."' and tenkhongdau='".$idl."'";
			$d->query($sql);
			$row_detail = $d->fetch_array();

			$d->reset();
			$sql = "select id,ten_$lang,tenkhongdau,photo from #_product_cat where hienthi=1 and type='".$type_bar."' and id_list='".$row_detail['id']."' order by stt,ngaytao desc";
			$d->query($sql);
			...
			$where = " #_product where hienthi=1 and type='".$type_bar."' and FIND_IN_SET('".$row_detail['id']."', id_list)  order by stt,ngaytao desc";

			$sql = "select ten_$lang,id,photo,mota_$lang,giacu,giaban,tenkhongdau,rate,masp from $where $limit";
			$d->query($sql);
			$product = $d->result_array();
			...
			$d->reset();
			$sql = "select id,ten_$lang,tenkhongdau,id_list,mota_$lang,title,keywords,description from #_product_cat where hienthi=1 and type='".$type_bar."' and tenkhongdau='".$idc."'";
			$d->query($sql);
			$row_detail = $d->fetch_array();
			...
			$d->reset();
			$sql = "select id,ten_$lang,tenkhongdau,photo from #_product_item where hienthi=1 and type='".$type_bar."' and id_cat='".$row_detail['id']."' order by stt,ngaytao desc";
			$d->query($sql);
			$row_item_tt = $d->result_array();
			...
			$where = " #_product where hienthi=1 and type='".$type_bar."' and FIND_IN_SET('".$row_detail['id']."', id_cat)  order by stt,ngaytao desc";
			...
			$d->reset();
			$sql = "select id,ten_$lang,tenkhongdau,title,keywords,description from #_product_item where hienthi=1 and type='".$type_bar."' and tenkhongdau='".$idi."'";
			$d->query($sql);
			$row_detail = $d->fetch_array();
