...
<div id="info">
  <div id="sanpham">  
    <div class="col-md-9 col-lg-9 col-sm-12 col-xx-12 col-xs-12">
      <div class="row">
        <div class="khung">
          <div class="thanh_title"><h2>Lỗi: không tìm thấy trang</h2></div>
          <div class="clear"></div>
          <div class="noidung" style="text-align:center;">

              <div id="box_cont"><center>
              <h1>404 Page</h1>
              <p>Rất tiếc, trang bạn tìm kiếm hiện không tồn tại hoặc có thể đã được chuyển sang địa chỉ khác.</p>
              <p>Bạn có thể <a href="javascript:history.go(-1)" title="Quay lại">quay lại</a>,
              hoặc về <a href="./">trang chủ</a> của chúng tôi.</p>
              </center></div>
