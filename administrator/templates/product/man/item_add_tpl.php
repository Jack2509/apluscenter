...
function get_main_list()
{
	...
	function get_main_cat()
	{
		...
		function get_main_item()
		{
			...
			<!--
			<div class="formRow">
					<label>Đóng dấu : <img src="./images/question-button.png" alt="Chọn loại" class="icon_que tipS" original-title="Bỏ chọn để không hiển thị danh mục này ! "> </label>
					<div class="formRight">
					<?php //dump($item['dongdau']);  ?>
					<input type="checkbox" name="dongdau" id="check1" value="0" <?=($item['dongdau']==1)?'checked="checked"':''?> />
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" name="chatlieu" title="Nhập chất liệu sản phẩm" id="chatlieu" class="tipS " value="<?=@$item['chatlieu']?>" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			<label>Màu sắc</label>
			<div class="formRight">
				<input type="text" name="mausac" title="Nhập Màu sắc sản phẩm" id="mausac" class="tipS " value="<?=@$item['mausac']?>" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" name="kichthuoc" title="Nhập kích thước sản phẩm" id="kichthuoc" class="tipS " value="<?=@$item['kichthuoc']?>" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			<label>Xuất xứ</label>
			<div class="formRight">
				<input type="text" name="xuatxu" title="Nhập xuất xứ sản phẩm" id="xuatxu" class="tipS " value="<?=@$item['xuatxu']?>" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" name="tinhtranghang" title="Nhập tình trạng sản phẩm" id="tinhtranghang" class="tipS " value="<?=@$item['tinhtranghang']?>" />
			</div>
			<div class="clear"></div>
		</div>
