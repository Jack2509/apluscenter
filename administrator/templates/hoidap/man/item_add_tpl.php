...
function get_main_list()
{
	...
	$str='
	<select id="id_list" name="id_list" data-level="0" data-type="'.$_GET['type'].'" data-table="table_hoidap_cat" data-child="id_cat" class="main_select select_danhmuc">
		...
		<div class="control_frm" style="margin-top:25px;">
			<div class="bc">
				<ul id="breadcrumbs" class="breadcrumbs">
					<li><a href="index.php?com=hoidap&act=add_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Thêm <?=$title_main?></span></a></li>
