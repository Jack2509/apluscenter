...
<form name="supplier" id="validate" class="form" action="index.php?com=setting&act=save&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
	...
	<div class="widget">
		...
		<!-- <div class="formRow">
			<label>T2 - T7</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['thu2']?>" name="thu2" title="Nhập T2 - T7" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['chunhat']?>" name="chunhat" title="Nhập chủ nhật" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
 -->
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['hotline2']?>" name="hotline2" title="Nhập hotline2" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			<label>Mã thuế</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['ma_thue']?>" name="ma_thue" title="Nhập mã thuế" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
	...
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="8" cols="" title="Code head" class="tipS" name="head"><?=@$item['head']?></textarea>
			</div>
			<div class="clear"></div>
		</div>	
		...
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="8" cols="" title="Code body_top" class="tipS" name="body_top"><?=@$item['body_top']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			...
			<div class="formRight">
				<textarea rows="8" cols="" title="Code body_bottom" class="tipS" name="body_bottom"><?=@$item['body_bottom']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
