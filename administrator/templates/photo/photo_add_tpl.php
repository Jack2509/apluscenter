<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
            ...
            <?php } else { ?>
            <li><a href="index.php?com=photo&act=man_photo<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Hình ảnh slider</span></a></li>
            <?php } ?>
...
<div class="formRow lang_hidden lang_vi active">
    <label>Mô tả</label>
    <div class="ck_editor">
        <textarea rows="4" cols="" title="Nhập mô tả . " id="mota_vi" class="tipS" name="mota_vi"><?=@$item['mota_vi']?></textarea>
    </div>
    <div class="clear"></div>
</div>
...
<div class="formRow lang_hidden lang_en">
    ...
    <div class="ck_editor">
        <textarea rows="4" cols="" title="Nhập mô tả . " id="mota_vi" class="tipS" name="mota_en"><?=@$item['mota_en']?></textarea>
    </div>
    <div class="clear"></div>
</div>
<?php } ?>
