				...
				<div class="wrapper">
					...
					<form name="supplier" id="validate" class="form" action="index.php?com=baiviet&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
						<div class="widget">
							...
							<?php if($_GET['type']=='khachhang') {?>

							<div class="formRow lang_hidden lang_vi active">
								<label>Ngành nghề</label>
								<div class="formRight">
									<input type="text" name="name_vi" title="Nhập tên danh mục" id="name_vi" class="tipS validate[required]" value="<?=@$item['name_vi']?>" />
								</div>
								<div class="clear"></div>
							</div>

							<div class="formRow lang_hidden lang_en">
								<label>Ngành nghề (Tiếng anh)</label>
								<div class="formRight">
									<input type="text" name="name_en" title="Nhập tên danh mục" id="name_en" class="tipS validate[required]" value="<?=@$item['name_en']?>" />
								</div>
								<div class="clear"></div>
							</div>
							<?php } ?>
							<?php if($_GET['type']=='banggia') {?>
							<div class="formRow ">
								<label>Giá</label>
								<div class="formRight">
									<input type="text" name="giaban" title="Nhập giá" id="giaban" class="tipS validate[required]" value="<?=@$item['giaban']?>" />
								</div>
								<div class="clear"></div>
							</div>
							<?php } ?>
							<?php if($_GET['type']=='mogioi') {?>
							<div class="formRow ">
							...
							<div class="formRow ">
								...
								<div class="formRight">
									<input type="text" name="mess" title="Nhập Messenger" id="mess" class="tipS validate[required]" value="<?=@$item['mess']?>" />
								</div>
								<div class="clear"></div>
							</div>	
							<?php } ?>
							...
							<?php } ?>
							<?php if($config_mota_in=='true'){ ?>
							<div class="formRow lang_hidden lang_vi active">
								<label>Mô tả</label>
								<div class="ck_editor">
									<textarea rows="4" cols="" id="mota_vi" title="Nhập mô tả . " class="tipS" name="mota_vi"><?=@$item['mota_vi']?></textarea>
								</div>
								<div class="clear"></div>
							</div>
							...
							<div class="formRow lang_hidden lang_en">
								<label>Mô tả (Tiếng anh)</label>
								<div class="ck_editor">
									<textarea rows="4" cols="" id="mota_en" title="Nhập mô tả . " class="tipS" name="mota_en"><?=@$item['mota_en']?></textarea>
								</div>
								<div class="clear"></div>
							</div>
							<?php } ?>
