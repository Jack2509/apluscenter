	...
	<form name="supplier" id="validate" class="form" action="index.php?com=baiviet&act=save_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
		<div class="widget">
			...
			<div class="formRow lang_hidden lang_en">
				...
				<div class="formRight">
					<input type="text" name="ten_en" title="Nhập màu danh mục" id="ten_en" class="tipS validate[required]" value="<?=@$item['ten_en']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<?php if($_GET['type']=='tuvan' || $_GET['type']=='tuyensinh') {?>
			<div class="formRow lang_hidden lang_vi active">
				<label>Màu</label>
				<div class="formRight">
					<input type="text" name="color" title="Nhập tên danh mục" id="color" class="color tipS validate[required]" value="<?=@$item['color']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<?php } ?>
			<?php if($config_images_l=='true'){ ?> 
			<div class="formRow">
				<label>Tải hình ảnh :</label>
				<div class="formRight">
					<input type="file" id="file" name="file" />
					<img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh JPEG, GIF , JPG , PNG)">
					<div class="note"> width : <?php echo _width_thumb_l*$ratio_;?> px , Height : <?php echo _height_thumb_l*$ratio_;?> px </div>
				</div>
				<div class="clear"></div>
			</div>
