...
<?php
  ...
  {
	global $item;
	// $list_id = json_decode($item["id_list"]);
    ...
    $str='
      <select id="id_list" name="id_list[]" multiple="multiple" onchange="select_list()" class="main_select">
...
<div class="wrapper">
	...
	<div class="control_frm" style="margin-top:25px;">
		<div class="bc">
			<ul id="breadcrumbs" class="breadcrumbs">
				<li><a href="index.php?com=baiviet&act=add_loai<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Thêm Danh mục cấp thương hiệu</span></a></li>
	...
	<form name="supplier" id="validate" class="form" action="index.php?com=baiviet&act=save_loai<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
		<div class="widget">
...
<!-- 			<div class="formRow">
			...
			<?php if($_GET['act']=='edit_loai'){?>
			<div class="formRow">
				<label>icon Hiện Tại :</label>
				<div class="formRight">
					
					<div class="mt10"><img src="<?=_upload_baiviet.$item['thumb']?>"  alt="NO PHOTO" width="22" /></div>
...
<!-- 			<div class="formRow">
				...
				<div class="formRight">
					...
					<div class="note"> width : 145 px , Height : 100 px </div>
				</div>
				<div class="clear"></div>
			</div>
			<?php if($_GET['act']=='edit_loai'){?>
			<div class="formRow">
				...
				<div class="formRight">
					<div class="mt10"><img src="<?=_upload_baiviet.$item['thumb']?>"  alt="NO PHOTO" width="200" /></div>
				</div>
				<div class="clear"></div>
			</div>
			<?php } ?> -->
		...
		<div class="widget">
			...
			<div class="formRow">
				<div class="formRight">
					...
					<a href="index.php?com=baiviet&act=man_loai<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
