<?php
      ...
      $d->reset();
      $sql = "SELECT COUNT(*) as num FROM #_dangky where view=0 ";
      $d->query($sql);
      $row_dangky = $d->fetch_array();
      ...
      $tong_count = $row_lienhe['num'];// + $row_dangky['num'];

      $d->reset();
      $sql = "SELECT COUNT(*) as num FROM #_comment where view=0 ";
      $d->query($sql);
      $row_comment = $d->fetch_array();
?>
<div class="wrapper">
            ...
            <ul>
                ...
                <li class="ddnew"><a title=""><img src="images/icons/topnav/messages.png" alt="" /><span>Thông báo</span><span class="numberTop"><?=$tong_count?></span></a>
                    <ul class="userMessage">
                        ...
                        <!-- <li><a href="index.php?com=dangky&act=man" title="" class="sInbox"><span>Đăng ký</span> <span class="numberTop" style="float:none; display:inline-block"><?=$row_dangky['num']?></span></a></li> -->
...
<!--                         <li><a href="index.php?com=order&act=man" title="" class="sInbox"><span>Đơn hàng</span> <span class="numberTop" style="float:none; display:inline-block"><?=$row_giohang['num']?></span></a></li>
                         <li><a href="index.php?com=comment&act=man" title="" class="sInbox"><span>Comment</span> <span class="numberTop" style="float:none; display:inline-block"><?=$row_comment['num']?></span></a></li>
-->
                    </ul>
                </li>
