...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
	...
	<tr style="text-align:center">
        <td></td>
        <td>STT</td>
        <td class=""><div>Tên<span></span></div></td>
        <td class="sortCol"><div>Email<span></span></div></td>
        <td class=""><div>Điện thoại<span></span></div></td>
	...
	<tr style="text-align:center">
		...
		<td style="width:20%;" align="center"><?=$items[$i]['ten']?></td>		        
        <td style="width:30%;" align="center"><b><?=$items[$i]['email']?></b></td>
        <td style="width:30%;" align="center"><b><?=$items[$i]['dienthoai']?></b></td>
