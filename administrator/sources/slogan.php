...
function save_banner(){
	...
	if($id){ 
		...
		$d->setWhere('type',$_GET['type']);
		if($d->update($data))
			redirect("index.php?com=slogan&act=capnhat&type=".$_GET['type']."");
		else
			transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=slogan&act=capnhat&type=".$_GET['type']."");
	}else{ // them moi
		...
		redirect("index.php?com=slogan&act=capnhat&type=".$_GET['type']."");
			...
			transfer("Lưu dữ liệu bị lỗi", "index.php?com=slogan&act=capnhat&type=".$_GET['type']."");
