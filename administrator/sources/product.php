...
function get_mans(){
	...
	$sql = "select ten_vi,id,stt,hienthi,id_list,id_cat,noibat,id_item,id_sub,banchay,soluong,moi from $where $limit";
	$d->query($sql);
...
function save_man(){
	...
	if($id){
		...
		$data['tinhtranghang'] = $_POST['tinhtranghang'];
		...
		$data['dongdau'] = isset($_POST['dongdau']) ? 1 : 0;
